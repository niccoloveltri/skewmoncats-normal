...
-- The soundness map, interpreting sequent calculus derivations as
...
sound Ir = id
sound (⊗r {S} {Γ} {Δ} f g) = sound f ⊗ sound g ∘ φ S Γ Δ
sound (Il f) = sound f
sound (⊗l f) = sound f 
sound (Ic Γ Δ f) = sound f ∘ [ ρ-1 ∣ Δ ]f
sound (⊗c Γ Δ cJ cJ' f) = sound f ∘ [ αJ-1 cJ' ∣ Δ ]f
