...
cmplt-uf-lemma {A}{B} (C ∷ Γ) f =
  ...
  ≗〈 cong⊗l⋆ (⊗l (cong-scut2 (⊗r (cmplt f) (uf ax)) (~ (⊗l⊗l-1 (⊗l-1⋆ (just (B ⊗ C)) Γ ax))))) 〉
  ⊗l⋆ (just (A ⊗ C)) Γ (⊗l (scut (⊗r (cmplt f) (uf ax)) (⊗l (⊗l-1 (⊗l-1⋆ (just (B ⊗ C)) Γ ax)))))
  ≗〈 cong⊗l⋆ {just (A ⊗ C)} {Γ} (⊗l (cong-scut2 (cmplt f) (≡-to-≗ (ccut-unit [] _ refl)))) 〉
...
cmplt-⊗r-ψ {A}{B}{C ∷ Δ}  =
  ...
  ≗〈 cong-scut2 (cmplt [ α ∣ Δ ]f) (cmplt-⊗r-ψ {Δ = Δ}) 〉 
  scut (cmplt [ α ∣ Δ ]f) (⊗l⋆ (just (A ⊗ (B ⊗ C))) Δ (⊗l (⊗r ax (uf (⊗l-1⋆ (just (B ⊗ C)) Δ ax)))))
  ≗〈 cong-scut1 (cmplt-uf-lemma Δ α) 〉 
...
cmplt-⊗r-lemma {just A} {[]} {Δ}  =
  ...
  ≗〈 cong⊗l⋆ {just A} {Δ} (cong-scut2 (⊗r ax Ir) (cong⊗l-1⋆ {just (A ⊗ I)} {Δ} (cmplt-⊗r-ψ {A}{I}{Δ}))) 〉
...
cmplt-⊗r-lemma {nothing} {[]} {Δ} =
  ...
  ≗〈 cong⊗l⋆ {just I} {Δ} (cong-scut2 (⊗r ax Ir) (cong⊗l-1⋆ {just (I ⊗ I)} {Δ} (cmplt-⊗r-ψ {I}{I}{Δ}))) 〉
...
ccut-lem : {S : Stp}{Γ Δ : Cxt}{A B C : Fma}
